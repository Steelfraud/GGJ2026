...
public class PoolObjectSettings
{
    ...
    public GameObject parentToSet = null;
    public Transform transformToFollow = null;
    public Vector3 positionToSet = new Vector3();
    internal Vector3 rigidbodyForceToSet = new Vector3();
    internal Quaternion rotationToSet = new Quaternion();
    public bool setLocalPositionAndRotation = false;
    internal bool setRigidBodyForce = false;
    internal float startTime;

    public float timeBeforeReturningToPool = 0; // If this is zero or lower, it is never automatically returned to the pool, but has to be manually done.

    public PoolObjectSettings ShallowClone()
    {
        return MemberwiseClone() as PoolObjectSettings;
    }
